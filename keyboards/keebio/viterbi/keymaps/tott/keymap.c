...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_ortho_5x14(
            ...
            KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,     KC_END,        KC_INS,  KC_N,     KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
            KC_LCTL, KC_LGUI, KC_LALT, MO(1),   TO(1),    MO(2),    KC_SPC,        KC_SPC,  MO(1),    TO(3),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT),
